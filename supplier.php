        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div id="collapseTwo" class="text-center" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-blue py-1 collapse-inner rounded">
                    ...
                    <hr class="sidebar-divider">
                    <p style="display: block;"><a class="collapse-item" style="color: white; font-weight: bold; font-size: 20px;">Suplier</a></p>                
                    <hr class="sidebar-divider">              
                </div>
            </div>
            ...
            <?php
                try {
                    ...
                    foreach ($produkData as $produk) {
                        ...
                        echo "<a href='edit/edit_supplier.php?id={$produk['suplier_id']}' class='btn btn-warning btn-sm'>Edit</a>";
                        echo " ";
